...
},{"sanctuary-type-identifiers":23}],22:[function(require,module,exports) {
var define;
/*
        @@@@@@@            @@@@@@@         @@
      @@       @@        @@       @@      @@@
...
},{"sanctuary-type-classes":21,"sanctuary-type-identifiers":22}],19:[function(require,module,exports) {
var define;
/*    #######
   ####     ####
 ####   ###   ####
...
},{"sanctuary-def":20,"sanctuary-type-classes":21,"sanctuary-type-identifiers":22}],11:[function(require,module,exports) {
'use strict';
...
},{"sanctuary":19}],10:[function(require,module,exports) {
...
},{"nearley":12,"./grammar.js":9,"./compiler":11,"../util":10}],3:[function(require,module,exports) {
'use strict';
/**
...
var errorsDom = document.getElementById('compile-errors');
...
var inputCodeMirror = CodeMirror.fromTextArea(input, {
    lineNumbers: true,
    mode: "javascript",
    theme: "abcdef"
});

var errors = CodeMirror.fromTextArea(errorsDom, {
    theme: "abcdef"
});

var compileAction = function compileAction() {
    var inputText = inputCodeMirror.getValue();
    errors.setValue('');
    try {
...
compileAction();
},{"../nearley/index":7}],25:[function(require,module,exports) {
